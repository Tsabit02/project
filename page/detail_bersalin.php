...
$id = isset($_GET['id_bersalin']) ? (int)$_GET['id_bersalin'] : 0;



$sql = "SELECT * FROM bersalin WHERE id_bersalin = $id LIMIT 1";
...
<div class="detail-card">
    <h2 class="detail-title">Detail Catatan Ibu <?= htmlspecialchars($data['nama_ibu']) ?></h2>
    <ul class="detail-list">
        <li>
            ...
            <span class="detail-value"><?= htmlspecialchars($data['nama_ibu']) ?></span>
        </li>
        <li>
            <span class="detail-label">
                <!-- Icon calendar -->
        ...
        <li>
            ...
            <span class="detail-value"><?= htmlspecialchars($data['tanggal_bersalin']) ?></span>
        </li>
        <li>
            <span class="detail-label">
                <!-- Icon clock/age -->
            ...
            <span class="detail-value"><?= htmlspecialchars($data['jenis_persalinan']) ?> tahun</span>
        </li>
        <li>
            <span class="detail-label">
                <!-- Icon calendar-check -->
            ...
            <span class="detail-value"><?= htmlspecialchars($data['jenis_kelamin']) ?></span>
        </li>
        <li>
            <span class="detail-label">
                <!-- Icon calendar-check -->
            ...
            <span class="detail-value"><?= htmlspecialchars($data['berat_bayi']) ?></span>
        </li>
        <li>
            <span class="detail-label">
                <!-- Icon note -->
    ...
    <a href="?page=data_bersalin" class="btn-kembali">&larr; Kembali</a>
